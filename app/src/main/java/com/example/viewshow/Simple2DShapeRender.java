...
public class Simple2DShapeRender implements GLSurfaceView.Renderer {
    ...
    public Simple2DShapeRender(String VShader, String FShader) {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //绘制三个点
//        GLES20.glDrawArrays(GLES20.GL_POINTS, 0, POSITION_COMPONENT_COUNT);
